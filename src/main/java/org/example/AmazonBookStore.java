...
public class AmazonBookStore {
    ...
    static final String AGE1 = "G";
    static final String AGE2 = "PG";
    static final String AGE3 = "PG 13";
    static final String AGE4 = "M";
